import Lab01.CourseRecord
import Lab01.Human
import Lab01.Major
import Lab01.Student
import org.junit.jupiter.api.Test
import org.junit.jupiter.api.Assertions.*

internal class Lab01test {
    ...
    fun testHuman() {
        ...
        assertEquals("Abebe Bikila", a.name)  // Corrected assertion
        assertEquals(21, a.age)  // Corrected assertion

        a.getOlder()
        assertEquals(22, a.age)  // Corrected assertion
    }
    @Test
    fun testAverage() {
        createStudents()
